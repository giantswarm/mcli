	...
	testCases := []struct {
		...
		},
		{
			...
			expectOutput: SecretFlags{
				...
				ClusterValues:                      "cluster-values\n",
				AzureClusterIdentityUA:             "azure: identity\nua: true\n",
				AzureSecretClusterIdentityStaticSP: "azure: identity\nstatic: sp\n",
				AzureClusterIdentitySP:             "azure: identity\nsp: true\n",
			},
		},
		{
		...
		},
		{
			...
			expectOutput: SecretFlags{
				...
				ClusterValues:            "cluster-values\n",
				CloudDirectorCredentials: "cloud: config\n",
			},
		},
		{
